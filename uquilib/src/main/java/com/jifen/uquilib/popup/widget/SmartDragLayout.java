package com.jifen.uquilib.popup.widget;
...
import com.jifen.uquilib.popup.enums.LayoutStatus;
...
public class SmartDragLayout extends FrameLayout implements NestedScrollingParent {
    ...
    private void finishScroll() {
        if (enableDrag) {
            ...
            scroller.startScroll(getScrollX(), getScrollY(), 0, dy, UPopup.getAnimationDuration());
