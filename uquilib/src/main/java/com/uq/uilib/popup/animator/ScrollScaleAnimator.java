package com.uq.uilib.popup.animator;
...
public class ScrollScaleAnimator extends PopupAnimator {
    ...
    public void animateShow() {
        ...
        animator.setDuration(UPopup.getAnimationDuration()).setInterpolator(new FastOutSlowInInterpolator());
        animator.start();
    }
    ...
    public void animateDismiss() {
        ...
        animator.setDuration(UPopup.getAnimationDuration())
